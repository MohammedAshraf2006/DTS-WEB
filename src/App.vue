<template>
  <div>
    ...
    <main>
      <HeroSection id="home" />
      <ServicesGrid id="services" class="reveal" />
      <Products id="products" class="reveal" />
      <WhyUs class="reveal" />
      <StatsCounter id="about" class="reveal" />
      <Clients class="reveal" />
      <Partners id="partners" class="reveal" />
    </main>
