# DTS-WEB V2 documentation

Canonical structural documentation for this repo.
...
- Wave plans and status: [`plans/`](../plans/)
- Cursor rules: [`.cursor/rules/`](../.cursor/rules/)
- External product reference: `C:\Users\PC\Desktop\DTS-WEB` (content/assets intent only)
